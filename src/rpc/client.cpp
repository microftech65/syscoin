...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendtoaddress", 8 , "skipassetoutputs" },
    { "sendtoaddress", 9 , "dustoutputs" },
    { "sendtoaddress", 10 , "dustamount" },
    { "settxfee", 0, "amount" },
    ...
    { "sendmany", 8 , "skipassetoutputs" },
    { "sendmany", 9 , "dustoutputs" },
    { "sendmany", 10 , "dustamount" },
    ...
    { "sendfrom", 2, "amount" },
    { "sendfrom", 3, "subtractfeefromamount" },
    { "sendfrom", 4 , "skipassetoutputs" },
    { "sendfrom", 5 , "dustoutputs" },
    { "sendfrom", 6 , "dustamount" },
